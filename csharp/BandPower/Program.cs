...
namespace MotionLogger
{
    class Program
    {
        ...
        const string OutFilePath = @"BandPower.csv";
        private static FileStream OutFileStream;

        static void Main(string[] args)
        {
            Console.WriteLine("BAND POWER");
            ...
            // Register Event
            p.OnPowDataReceived += OnPowDataReceived;
            p.SessionCtr.OnSubcribePowOK += OnPowDataReceived;
        ...
        private static void OnPowDataReceived(object sender, ArrayList powData)
        {
            WriteDataToFile(powData);
        }
    }
}
